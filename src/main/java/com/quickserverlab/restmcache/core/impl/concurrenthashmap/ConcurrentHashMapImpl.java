package com.quickserverlab.restmcache.core.impl.concurrenthashmap;

import com.quickserverlab.restmcache.core.impl.BaseCacheImpl;
import java.io.*;
...
public class ConcurrentHashMapImpl extends BaseCacheImpl {
	...
	public Object getFromCache(String key) throws Exception {
		...
		if (object != null) {
			...
			logger.log(Level.FINEST, "no value in db for key: {0}", key);
			return null;
		}
	}
	...
	private String fileName = "./"+getName()+"_"+getPort()+".dat";
